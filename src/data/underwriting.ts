// Belgian Compromis de Vente — Apt 4B, Rivus Deurne
// Buyer: Van Damme, K. | Contract compliance screening demo

export const underwritingDeal = {
  property: {
    name: "Rivus Deurne — Apt 4B",
    address: "Rivus residentie, Kloosterstraat 18, 2100 Deurne",
    units: 32,
    class: "B" as const,
    yearBuilt: 2026,
    sqft: 950,
  ...
  aiFlags: [
    {
      ...
      message: "Soil certificate reference missing. Belgian Bodemdecreet (Art. 101) requires the compromis to reference a soil certificate for any built-up parcel. Suggested correction attached below.",
      field: "Soil certificate (Bodemattest)",
      omValue: "Not referenced in contract",
      modelValue: "Required by law",
    },
    {
      id: 2,
      severity: "warning" as const,
      message: "Cooling-off period clause incomplete. Contract mentions the 14-day cooling-off window but does not cite Art. VI.68 WER explicitly. Recommend full legal citation to avoid future dispute.",
      field: "Cooling-off period (Art. VI.68 WER)",
      omValue: "Partial reference",
      modelValue: "Full citation required",
    },
    {
      id: 3,
      severity: "info" as const,
      message: "Price matches master price list exactly (EUR 385,000). No adjustment flags. Deposit (10% = EUR 38,500) is within Straco's standard range.",
      field: "Price verification",
      omValue: "EUR 385,000",
      modelValue: "EUR 385,000 (MATCH)",
    },
  ],
  processingSteps: [
    { label: "Parsing compromis de vente...", duration: 1200 },
    { label: "Extracting buyer + unit identification...", duration: 800 },
    { label: "Reading price + payment schedule...", duration: 600 },
    { label: "Checking conditions precedent (mortgage, soil)...", duration: 700 },
    { label: "Cross-referencing Straco master price list...", duration: 900 },
    { label: "Validating against Belgian legal checklist...", duration: 700 },
    { label: "Verifying required certificates + disclosures...", duration: 600 },
    { label: "Building compliance report...", duration: 400 },
  ],
}
