...
const KPI_CARDS = [
  ...
  },
  {
    ...
    suffix: "",
    decimals: 0,
    delta: "2 in permit phase",
    deltaPositive: true,
    sparkData: [4, 5, 5, 6, 6, 7, 8, 8],
    sparkColor: "#2F855A",
  },
  {
  ...
  },
  {
    ...
    suffix: "",
    decimals: 0,
    delta: "BE · GR · LU · PL · RO · ES",
    deltaPositive: true,
    sparkData: [2, 3, 3, 4, 4, 5, 6, 6],
    sparkColor: "#C8A96E",
  },
]
